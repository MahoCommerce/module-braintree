...
class Gene_Braintree_Model_Source_Creditcard_FormIntegration
{
    ...
    public const INTEGRATION_ACTION_XML_PATH = 'payment/gene_braintree_creditcard/form_integration';
